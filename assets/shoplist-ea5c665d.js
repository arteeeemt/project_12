import"./support-26a65028.js";const o=document.querySelector(".js-shoping-list-book"),p=document.querySelector(".listOfBookFromCategory");let i=JSON.parse(localStorage.getItem("books"));e();o.addEventListener("click",r);function e(){if(!i||i.length===0){const s=l();p.innerHTML=s,o.style.display="none";return}o.style.display="flex",o.innerHTML=a(i)}function r(s){if(s.target.tagName!="BUTTON")return;const t=i.findIndex(n=>n._id===s.target.dataset.id);i.splice(t,1),localStorage.setItem("books",JSON.stringify(i)),e()}function l(){return` <div class="shoping-empty">
